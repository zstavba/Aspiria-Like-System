...
<div class="row mx-auto  w-5/6  m-10 bg-white rounded p-5" style="height: auto; min-height: 50vh;">
	<div class="mb-5">
	  ...
	  <div class="mt-1">
	    <input type="text" name="email" id="email" class="p-2 w-full border-indigo-500 border-b-2 focus:border-indigo-700 focus:border-b-2 focus:outline-none" placeholder="Uproabniško ime / e-naslov">
	  </div>
	</div>
	<div class="mb-5">
	  ...
	  <div class="mt-1">
	    <input type="password" name="password" id="password" class="p-2 w-full border-indigo-500 border-b-2 focus:border-indigo-700 focus:border-b-2 focus:outline-none" placeholder="Geslo">
	  </div>
	</div>
